...
**********************************************************/
char SMSGSM::SendSMS(const char *number_str, char *message_str)
{
...
**********************************************************/
char SMSGSM::GetSMS(byte position,
	 	 	 	 	char *phone_number,
	 	 	 	 	char *SMS_text,
	 	 	 	 	char *sender,
	 	 	 	 	char *date_and_time,
     ...
     case RX_FINISHED_STR_RECV:
          ...
          if (p_char != NULL) {
        	  ...
        	  if (p_char1 != NULL)
        		  *p_char1 = 0;
        	  strcpy(sender, (char *)(p_char));
          }

          // extract date and time when the message was sent
          ...
          if (p_char1 != NULL) {
        	  ...
        	  if (p_char != NULL)
        		  *p_char = 0; // end of string
        	  strcpy(date_and_time, (char *)(p_char1));
          }
                              ...
                              byte first_authorized_pos, byte last_authorized_pos)
{
     ...
     ret_val = GetSMS(position, phone_number, SMS_text, NULL, NULL, max_SMS_len);
     if (ret_val < 0) {
